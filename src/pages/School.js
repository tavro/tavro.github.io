    ...
    <div className="School">
      ...
      <main>
        ...
        <ul>
          ...
          <img alt="LiU" src={'/school/liu.jpeg'} className="nondragable"/>
          ...
          <img alt="LBS" src={'/school/lbs.jpg'} className="nondragable"/>
          ...
          <img alt="Gronkulla" src={'/school/gronkulla.png'} className="nondragable"/>
          <p>When I went to Grönkullaskolan I first got introduced to gamedevelopment in Scratch (2009) and later started to develop mods to Minecraft in Java (2011-2012)</p>
            <img alt="Blastad" src={'/school/blastad.jpg'} className="nondragable"/>
          <p>I moved to Linköping and took a break from gamedevelopment and programming during my time at Blästadsskolan (2012-2013)</p>
            <img alt="Haga" src={'/school/haga.jpg'} className="nondragable"/>
